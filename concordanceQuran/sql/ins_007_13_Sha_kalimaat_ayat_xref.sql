...
OR (s.soorah_seq_no = 56 AND a.ayat_seq_no IN (55))
    );
COMMIT;
INSERT INTO kalimaat_ayat_xref (kalimaat_id, ayat_id)
SELECT k.kalimaat_id, a.ayat_id
...
OR (s.soorah_seq_no = 2 AND a.ayat_seq_no IN (93))
    );
COMMIT;
INSERT INTO kalimaat_ayat_xref (kalimaat_id, ayat_id)
SELECT k.kalimaat_id, a.ayat_id
...
FROM soorah s, ayat a, kalimaat k
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'اشْكُر'
AND ( (s.soorah_seq_no = 27 AND a.ayat_seq_no IN (19,40))
OR (s.soorah_seq_no = 46 AND a.ayat_seq_no IN (15))
OR (s.soorah_seq_no = 31 AND a.ayat_seq_no IN (12,14))
    );
COMMIT;
INSERT INTO kalimaat_ayat_xref (kalimaat_id, ayat_id)
SELECT k.kalimaat_id, a.ayat_id
...
FROM soorah s, ayat a, kalimaat k
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'اشْهد'
AND ( (s.soorah_seq_no = 6 AND a.ayat_seq_no IN (19))
OR (s.soorah_seq_no = 3 AND a.ayat_seq_no IN (52))
...
OR (s.soorah_seq_no = 2 AND a.ayat_seq_no IN (204))
    );
COMMIT;
INSERT INTO kalimaat_ayat_xref (kalimaat_id, ayat_id)
SELECT k.kalimaat_id, a.ayat_id

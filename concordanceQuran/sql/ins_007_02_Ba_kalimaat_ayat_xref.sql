...
OR (s.soorah_seq_no = 16 and a.ayat_seq_no IN (58,59))
...
FROM soorah s, ayat a, kalimaat k 
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'أَبْصر'
AND (
    (s.soorah_seq_no = 6 and a.ayat_seq_no IN (104))
OR (s.soorah_seq_no = 37 and a.ayat_seq_no IN (179))
...
FROM soorah s, ayat a, kalimaat k 
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'أَبْصَرْنَا'
AND (
...
FROM soorah s, ayat a, kalimaat k 
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'بَعدَتْ'
AND (
    (s.soorah_seq_no = 9 and a.ayat_seq_no IN (42))
OR (s.soorah_seq_no = 11 and a.ayat_seq_no IN (95))
    );
COMMIT;
...
OR (s.soorah_seq_no = 2 and a.ayat_seq_no IN (187))
...
FROM soorah s, ayat a, kalimaat k 
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'بنى'
AND (
    (s.soorah_seq_no = 2 and a.ayat_seq_no IN (40,47,83,122,211,246,132))
...
FROM soorah s, ayat a, kalimaat k 
WHERE s.soorah_id = a.soorah_id
AND k.kalimah_text = 'يبيتُونَ'
AND (
    (s.soorah_seq_no = 25 and a.ayat_seq_no IN (64))
OR (s.soorah_seq_no = 4 and a.ayat_seq_no IN (81,108))
    );
COMMIT;
